...
if os.path.exists("additional_employees.json") and os.path.getsize("additional_employees.json")>0:
    json_employees = pd.read_json("additional_employees.json")
else:
    json_employees = pd.DataFrame()
...
if os.path.exists("dirty_data.csv"):
